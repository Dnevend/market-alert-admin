...
const authWalletSignInRoute = authWalletSignInRouteImport.update({
  id: '/(auth)/wallet-sign-in',
  path: '/wallet-sign-in',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface RootRouteChildren {
  ...
  authWalletSignInRoute: typeof authWalletSignInRoute
...
const rootRouteChildren: RootRouteChildren = {
  ...
  authWalletSignInRoute: authWalletSignInRoute,
